...
INSTALLED_APPS = [
    ...
    'app.auth',  # Authentication app
    'app.hotels',  # Hotels app
    'app.restaurants',  # Restaurants app
    'app.tourist_spots',  # Tourist spots app
    'app.bookings',  # Bookings app
]
...
# JWT authentication settings (you can adjust expiry times)
SIMPLE_JWT = {
